 ...
 * Created by Villey on 2016/12/28.
 */
...
public class RoundedTextView extends AppCompatTextView {
    ...
    private static final int DEFAULT_BORDER_WIDTH = 1;          // 3 px
    private static final int DEFAULT_BACKGROUND_COLOR = Color.WHITE;  // 默认背景白色

    private int mCornerRadius;    // 圆角半径 （默认自适应控件高度）
    private int mBorderWidth;   // 边框线的宽度（粗细）
