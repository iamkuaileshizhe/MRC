...
public class CheDanDialog extends Dialog implements View.OnClickListener {
    ...
    public CheDanDialog(Context context) {
        this(context, 0, null);
    }

    public CheDanDialog(Context context, int theme, View contentView) {
...
//					}
                    ...
                    Toast.makeText(mContext, "请输入重新调度原因", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    if (onPosNegClickListener != null) {
