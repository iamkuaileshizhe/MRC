...
public class VeryfyEditDialog extends Dialog implements View.OnClickListener {
    ...
    public VeryfyEditDialog(Context context) {
        this(context, 0, null);
    }

    public VeryfyEditDialog(Context context, int theme, View contentView) {
        ...
        if (mView == null) {
            mView = View.inflate(mContext, R.layout.veryfy_view_edit, null);
        }
...
//					}
                    ...
                    Toast.makeText(mContext, "请输入描述原因", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    if (onPosNegClickListener != null) {
