...
public class OrderComEdittextTicket extends RelativeLayout {

    private TextView editTitle;
    private EditText editContent;
    private TextView danwei;

    public OrderComEdittextTicket(Context context) {
        super(context);
        initView(context);
    }

    public OrderComEdittextTicket(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public OrderComEdittextTicket(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.order_com_edittext_ticket, this);
