...
public class JiaoBanFragment extends BaseFragment implements XListView.IXListViewListener {
...
//        requestBean.setRecordStatus("");
        ...
        carryUserBean.setBeginNum(currentPage);
        carryUserBean.setCarryUserId(userInfo.getUserId());
        carryUserBean.setEndNum(Constant.PER_PAGE_NUMS);
        carryUserBean.setShiftStatus("");


        RequestBody requestBody = HttpManger.getHttpMangerInstance().getRequestBody(carryUserBean);
