...
public class TiYouNewYiQueRenFragment extends BaseFragment implements XListView.IXListViewListener {
...
//        tiYNewReqBean.setCarCode("鲁AY3K10");
        tiYNewReqBean.setRecordStatus(Constant.TY_REC_YIWANCHENG + "," + Constant.TY_REC_TIYOUWACHENG); // 已完成 提油完成
