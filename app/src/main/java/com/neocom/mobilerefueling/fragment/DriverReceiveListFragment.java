...
public class DriverReceiveListFragment extends BaseFragment {
    ...
    private String[] mTabNames = UIUtils.getStringArray(R.array.driver_list_names);
    private View view;
...
//                simplePagerTitleView.setSelectedColor(Color.WHITE);
    ...
    class DriverRecAdapter extends FragmentStatePagerAdapter {
        ...
        public DriverRecAdapter(FragmentManager fm) {
            super(fm);
            mTabNames = UIUtils.getStringArray(R.array.driver_list_names);
        }
...
//            return super.getPageTitle(position);
        ...
        public Fragment getItem(int position) {
            return DriverOrderFactory.createFragment(position);
        }
