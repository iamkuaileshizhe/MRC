...
public class YiJieBanFragment extends BaseFragment implements XListView.IXListViewListener {
...
//        requestBean.setRecordStatus("");
        ...
        turnedUserBean.setShiftStatus(SHIFTED);
