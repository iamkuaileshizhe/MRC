...
public class QianZaiKeHuListFragment extends BaseFragment {
    ...
    private String[] mTabNames = UIUtils.getStringArray(R.array.potential_kehu);
    private View view;
...
//                simplePagerTitleView.setSelectedColor(Color.WHITE);
    ...
    class DriverRecAdapter extends FragmentStatePagerAdapter {
        ...
        public DriverRecAdapter(FragmentManager fm) {
            super(fm);
            mTabNames = UIUtils.getStringArray(R.array.potential_kehu);
        }
