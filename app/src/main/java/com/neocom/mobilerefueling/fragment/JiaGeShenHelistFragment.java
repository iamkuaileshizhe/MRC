...
public class JiaGeShenHelistFragment extends BaseFragment implements XListView.IXListViewListener {
...
//        reqBean.setRoleCode(GetOrderStateUtil.getRoleCode(userInfo.getRoleCode()));
        ...
        Call<QZKHRespBean> call = HttpManger.getHttpMangerInstance().getServices().findPriceCheckList(requestBody);
