...
public class HeTongNewListFragment extends BaseFragment implements XListView.IXListViewListener {
...
//    private YunYouCheListAdapter receiveListAdapter;
    private HeTongAdapter receiveListAdapter;

    List<HeTongResBean.BringBean> bringShow;
...
//            super.handleMessage(msg);
            ...
            switch (msg.what) {
                ...
                case 102:
                    ...
                    bringShow = (List<HeTongResBean.BringBean>) msg.obj;
...
//                            CURRENT_PAGE_NUMBER++;
                        ...
                        if (bringShow != null) {
                            ...
                            receiveListAdapter = new HeTongAdapter(getActivity(),bringShow);
...
//
//                HeTongResBean.BringBean item = receiveListAdapter.getItem(i - 1);
//                String itemId = item.getId();
//                String itemStatus = item.getStatus();
//                Log.i(TAG, "未确认onItemClick: "+itemId+";"+itemStatus);
//                Intent intent=new Intent(UIUtils.getContext(), YunYouDetailActivity.class);
//                intent.putExtra("itemId", itemId);
//                intent.putExtra("itemStatus","0");// 未确认 0
...
//        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("hetongId", receiveListAdapter.getItem(i - 1).getBatchNum());
...
//        RequestBody requestBody = RequestBody.create(MediaType.parse(Constant.CONTENT_TYPE), carNumJson);
        ...
        Call<HeTongResBean> call = HttpManger.getHttpMangerInstance().getServices().searchContractList(requestBody);
//        Call<YunYouCheResponseBean> call = HttpManger.getHttpMangerInstance().getServices().findSupplyListByCarNum(requestBody);
        call.enqueue(new Callback<HeTongResBean>() {
            @Override
            public void onResponse(Call<HeTongResBean> call, Response<HeTongResBean> response) {
                ...
                if (response.body()!=null){
                    ...
                    List<HeTongResBean.BringBean> bring = response.body().getBring();
                    if (bring != null) {
    ...
    private void processJson( List<HeTongResBean.BringBean> bring) {
