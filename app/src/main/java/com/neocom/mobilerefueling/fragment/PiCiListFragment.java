...
public class PiCiListFragment extends BaseFragment implements XListView.IXListViewListener {
...
//    private YunYouCheListAdapter receiveListAdapter;
    private GetPiciAdapter receiveListAdapter;

    List<PiCiBringBean> bringShow;
...
//            super.handleMessage(msg);
            ...
            switch (msg.what) {
                ...
                case 102:
                    ...
                    bringShow = (List<PiCiBringBean>) msg.obj;
...
//                            CURRENT_PAGE_NUMBER++;
                        ...
                        if (bringShow != null) {
                            ...
                            receiveListAdapter = new GetPiciAdapter(getActivity(),bringShow);
...
//                getActivity().finish();
                ...
                Intent intent = new Intent();
                intent.putExtra("batchId", receiveListAdapter.getItem(i - 1).getBatchNum());
...
//        Call<YunYouCheResponseBean> call = HttpManger.getHttpMangerInstance().getServices().findSupplyListByCarNum(requestBody);
        call.enqueue(new Callback<GetPiCiBean>() {
            ...
            public void onResponse(Call<GetPiCiBean> call, Response<GetPiCiBean> response) {
                ...
                if (response.body()!=null){
                    ...
                    List<PiCiBringBean> bring = response.body().getBring();
                    if (bring != null) {
    ...
    private void processJson(  List<PiCiBringBean> bring) {
