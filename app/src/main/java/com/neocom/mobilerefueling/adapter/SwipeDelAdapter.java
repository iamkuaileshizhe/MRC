...
import com.neocom.mobilerefueling.bean.SwipeBean;
...
public class SwipeDelAdapter extends RecyclerView.Adapter<SwipeDelAdapter.SwipeDelVH>{
    ...
    public SwipeDelAdapter(Context context, List<SwipeBean> mDatas) {
        mContext = context;
    ...
    public SwipeDelVH onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SwipeDelVH(mInfalter.inflate(R.layout.item_cst_swipe, parent, false));
    }

    @Override
    public void onBindViewHolder(final SwipeDelVH holder, final int position) {
