...
public class QZKHListAdapter extends BaseAdapter {

//    List<ReceiverOrderBeanBring.BringBean> bringList;

    List<KHDetailBringBean> bringList;

    public QZKHListAdapter(List<KHDetailBringBean> bringList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = UIUtils.inflate(R.layout.qzkh_item_layout);
        ...
        KHDetailBringBean khBringBean = bringList.get(position);


        holder.kehuCompName.setText(khBringBean.getCusname());

        holder.kehuInTime.setText("录入时间:"+khBringBean.getCdt());
         ...
         * 完成是 灰色  10
         */
        String status = khBringBean.getCheckStatus();
...
//            普通蓝色
    ...
    class ViewHolder {
        ...
        @BindView(R.id.kehu_comp_state)
        TextView kehuCompState;
        @BindView(R.id.kehu_in_time)
        TextView kehuInTime;
