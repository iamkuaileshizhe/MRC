...
public class YpGbDownAdapter extends BaseAdapter {

    private Context context;
    private List<OilLXGBBean.BringBean>  list;
    ...
    public YpGbDownAdapter(Context context, List<OilLXGBBean.BringBean>  list) {
    ...
    @Override
    public OilLXGBBean.BringBean getItem(int position) {
